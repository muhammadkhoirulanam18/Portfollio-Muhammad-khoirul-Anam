<template>
  ...
  <section class="py-16 px-6 max-w-7xl mx-auto">
    <div class="bg-[#111215] rounded-2xl overflow-hidden grid grid-cols-1 md:grid-cols-12 items-center relative border border-neutral-800">
      ...
      <div class="p-8 md:p-16 md:col-span-7 space-y-6 z-10 text-left flex flex-col items-start">
        ...
        <div class="pt-4 w-full flex justify-start">
          <a 
            ...
            target="_blank"
            class="inline-block bg-secondary text-on-secondary px-unit-lg py-unit-md rounded-lg font-label-mono text-label-mono font-bold hover:bg-primary-container transition-all"
          >
      ...
      <div class="relative md:col-span-5 h-full min-h-[300px] md:min-h-[400px] flex items-end justify-end overflow-hidden">
