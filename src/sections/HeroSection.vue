    ...
    <header class="relative min-h-screen flex items-center pt-24 overflow-hidden">
      ...
      <div class="max-w-container-max mx-auto px-gutter grid md:grid-cols-2 gap-12 md:gap-unit-lg items-center">
        <div class="text-left order-2 md:order-1">
          <span class="font-label-mono text-label-mono text-secondary tracking-widest block mb-unit-md">HELLO EVERYONE!</span>
          <h1 class="font-display-lg text-display-lg-mobile md:text-display-lg text-primary mb-unit-lg leading-none">
            Building websites that <span class="text-secondary text-glow">look good</span> and work well.
          </h1>
          <p class="font-body-lg text-body-lg text-on-surface-variant max-w-lg mb-unit-lg">
            Front-End Developer with experience in Webflow, Wix, WordPress, JavaScript, and the Astro framework, focused on building clean, responsive, and user-friendly experience.
          </p>
          <div class="flex flex-wrap items-center justify-start gap-unit-md">
            <button class="bg-secondary text-on-secondary px-unit-lg py-unit-md rounded-lg font-label-mono text-label-mono font-bold hover:bg-primary-container transition-all">Contact Me</button>
            <a href="https://drive.google.com/file/d/1d5K1AVdEINk3C1Pa0Yq0tYOdLdtAJvgq/view?usp=drive_link" download class="border border-secondary/30 text-secondary px-unit-lg py-unit-md rounded-lg font-label-mono text-label-mono font-bold hover:bg-secondary/5 transition-all flex items-center gap-2">
              Download CV
            ...
            <a href="https://www.linkedin.com/in/muhammadkhoirulanamm/" target="https://www.linkedin.com/in/muhammadkhoirulanamm/" aria-label="LinkedIn" class="w-11 h-11 rounded-full border border-secondary/30 flex items-center justify-center text-secondary hover:bg-secondary/10 transition-all group">
            ...
            <a href="https://wa.me/6285783928671" target="https://wa.me/6285783928671" aria-label="WhatsApp" class="w-11 h-11 rounded-full border border-secondary/30 flex items-center justify-center text-secondary hover:bg-secondary/10 transition-all group">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 group-hover:scale-110 transition-transform">
        ...
        <div class="relative mt-8 md:mt-0 flex justify-center animate-float order-1 md:order-2">
          <div class="relative w-64 h-64 sm:w-80 sm:h-80 md:w-[450px] md:h-[450px] group">
            ...
            <div class="absolute inset-4 rounded-full border border-secondary/10 animate-[spin_15s_linear_infinite_reverse]"></div>
