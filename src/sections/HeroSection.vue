  ...
  <div class="bg-background">
    ...
    <header class="relative min-h-screen flex items-center pt-24 overflow-hidden">
      ...
      <div class="max-w-container-max mx-auto px-gutter grid md:grid-cols-2 gap-12 md:gap-unit-lg items-center">
        <div class="text-center md:text-left order-2 md:order-1 flex flex-col items-center md:items-start">
...
I’m currently open to full-time (WFH/WFO), freelance, part-time, or project-based roles. Let’s team up!"
          ...
          <div class="flex flex-col md:flex-row flex-wrap items-center justify-center md:justify-start gap-4 md:gap-unit-md mt-6 w-full md:w-auto">
            ...
            <!-- Social Icons Group -->
            <div class="flex items-center gap-3">
              <a href="https://www.linkedin.com/in/muhammadkhoirulanamm/" target="_blank" aria-label="LinkedIn" class="w-11 h-11 md:w-12 md:h-12 rounded-full border border-secondary/30 flex items-center justify-center text-secondary hover:bg-secondary/10 transition-all group shrink-0">
              ...
              <a href="https://wa.me/6285783928671" target="_blank" aria-label="WhatsApp" class="w-11 h-11 md:w-12 md:h-12 rounded-full border border-secondary/30 flex items-center justify-center text-secondary hover:bg-secondary/10 transition-all group shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 group-hover:scale-110 transition-transform">
