...
I’m currently open to full-time (WFH/WFO), freelance, part-time, or project-based roles. Let’s team up!"
          ...
          <div v-reveal="{ delay: 300 }" class="flex flex-wrap items-center justify-start gap-4 md:gap-6 mt-6 w-full">
            ...
            <div class="flex items-center gap-3">
              <a href="https://www.linkedin.com/in/muhammadkhoirulanamm/" target="_blank" aria-label="LinkedIn" class="w-12 h-12 rounded-full border border-secondary/30 flex items-center justify-center text-secondary hover:bg-secondary/10 hover:-translate-y-1 hover:border-secondary/60 transition-all group shrink-0">
              ...
              <a href="https://wa.me/6285783928671" target="_blank" aria-label="WhatsApp" class="w-12 h-12 rounded-full border border-secondary/30 flex items-center justify-center text-secondary hover:bg-secondary/10 hover:-translate-y-1 hover:border-secondary/60 transition-all group shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 group-hover:scale-110 transition-transform">
